...
function AppContent({ triggerRef, recruiterOpen, setRecruiterOpen }) {
  ...
  return (
    <div 
      className={isHome 
        ? "grid grid-cols-1 md:grid-cols-[280px_1fr_280px] grid-rows-none md:grid-rows-[56px_1fr_140px] gap-[10px] p-[10px] h-auto md:h-screen w-full md:w-screen bg-[#04020a] overflow-y-auto md:overflow-hidden text-white font-sans relative"
